...
*/
//using iterative pointer approach most optimal
...
*/
        ...
        ListNode* temp=dummy;
        while(list1!=nullptr && list2!=nullptr){//The loop continues only while BOTH lists still have nodes:
            if(list1->val<list2->val){   //while(list1 && list2){
                temp->next=list1;
